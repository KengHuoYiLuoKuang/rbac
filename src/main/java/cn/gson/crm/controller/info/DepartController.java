...
import cn.gson.crm.model.dao.DepartDao;
...
public class DepartController {
    ...
    @RequestMapping("/list")
    @ResponseBody
    public DataGrid<Depart> list(int page, int rows, String userName, String realName, String telephone) {
        PageRequest pr = new PageRequest(page - 1, rows);

        //使用了自定义的复杂查询，这就比原生的Specification的语法使用流畅多了
        Page pageData = departDao.findAll(new MySpecification<Member>().and(
